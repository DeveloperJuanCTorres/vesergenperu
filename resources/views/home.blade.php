        ...
        <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
            <div class="product-item bg-light mb-4">
                <div class="product-img position-relative overflow-hidden">  
                    @php
                        $imagen = json_decode($item->image);
                    @endphp        
                    <img class="img-fluid w-100" src="storage/{{$imagen[0]}}" alt="">
                    <div class="product-action">
                        <a class="btn btn-outline-dark btn-square" href="{{route('detailid',$item)}}"><i class="fa fa-shopping-cart"></i></a>
                        <a class="btn btn-outline-dark btn-square" href=""><i class="far fa-heart"></i></a>
                        <a class="btn btn-outline-dark btn-square" href=""><i class="fa fa-sync-alt"></i></a>
                        <a class="btn btn-outline-dark btn-square" href="{{route('detailid',$item)}}"><i class="fa fa-search"></i></a>
                    </div>
                </div>
                <div class="text-center py-4">
                    <a class="h6 text-decoration-none text-truncate" href="{{route('detailid',$item)}}">{{$item->name}}</a>
                    <div class="d-flex align-items-center justify-content-center mt-2">
                        @if($item->promo!=null)
                            <h5>S/. {{$item->price - ($item->price/$item->promo)}}</h5>
                            <h6 class="text-muted ml-2"><del>S/. {{$item->price}}</del></h6>
                        @else
                            <h5>S/. {{$item->price}}</h5>
                        @endif                        
                    </div>
